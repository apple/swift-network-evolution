...
public final class TestNetworkProtocolStorage: BaseNetworkProtocolStorage {
    ...
    public func releaseHeldInstances() {
        ...
        // holds it, which trips a precondition when the harness is destroyed. This is the end of
        // the harnesses' lives, so retire whatever is still registered before letting go.
        for harness in datagramUpperHarnessesForTest { harness.retireEventStateForTest() }
        for harness in datagramLowerHarnessesForTest { harness.retireEventStateForTest() }
        for harness in newDatagramFlowHarnessesForTest { harness.retireEventStateForTest() }
        for harness in streamUpperHarnessesForTest { harness.retireEventStateForTest() }
        for harness in streamLowerHarnessesForTest { harness.retireEventStateForTest() }
        for harness in newStreamFlowHarnessesForTest { harness.retireEventStateForTest() }

        datagramUpperHarnessesForTest.removeAll()
        datagramLowerHarnessesForTest.removeAll()
        newDatagramFlowHarnessesForTest.removeAll()
        streamUpperHarnessesForTest.removeAll()
        streamLowerHarnessesForTest.removeAll()
        newStreamFlowHarnessesForTest.removeAll()
    }
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestInboundDatagramLinkage: InboundDatagramLinkage {
    ...
    public func handleConnectedEvent(
        ...
        case .base: base.handleConnectedEvent(for: instance, in: &eventContext)
        }
    }
    ...
    public func handleDisconnectedEvent(
        ...
        case .base: base.handleDisconnectedEvent(error: error, for: instance, in: &eventContext)
        }
    }
    ...
    public func handleNetworkProtocolEvent(
        ...
        case .base: base.handleNetworkProtocolEvent(event: event, for: instance, in: &eventContext)
        }
    }
    ...
    public func handleInboundDataAvailableEvent(
        ...
        case .base: base.handleInboundDataAvailableEvent(for: instance, in: &eventContext)
        }
    }
    ...
    public func handleOutboundRoomAvailableEvent(
        ...
        case .base: base.handleOutboundRoomAvailableEvent(for: instance, in: &eventContext)
        }
    }
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestOutboundDatagramLinkage: OutboundDatagramLinkage {
    ...
    public func protocolIsConnected(in eventContext: inout NetworkContext.EventContext) -> Bool {
        ...
        case .base: return base.protocolIsConnected(in: &eventContext)
        }
    }
    ...
    public func sendDatagrams(
        ...
        case .base: try base.sendDatagrams(datagrams, from: instance, in: &eventContext)
        }
    }
    ...
    public func connect(for instance: InstanceIdentifier, in eventContext: inout NetworkContext.EventContext) {
        ...
        case .base: base.connect(for: instance, in: &eventContext)
        }
    }
    ...
    public func disconnect(
        ...
        case .base: base.disconnect(error: error, for: instance, in: &eventContext)
        }
    }
    ...
    public func detach(
        ...
        case .base: try base.detach(for: instance, in: &eventContext)
        }
    }
    ...
    public func teardown(in eventContext: inout NetworkContext.EventContext) {
        ...
        case .base: base.teardown(in: &eventContext)
        }
    }
    ...
    public func handleApplicationEvent(
        ...
        case .base: base.handleApplicationEvent(event: event, for: instance, in: &eventContext)
        }
    }
    ...
    public func getMetadata<P: NetworkProtocol>(
        ...
        case .base: return base.getMetadata(for: instance, in: &eventContext)
        }
    }
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestInboundDatagramFlowLinkage: InboundDatagramFlowLinkage {
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestDatagramListenerLinkage: DatagramListenerLinkage {
...
final class TestExternalDatagramMultipath: ExternalDatagramMultipathLinkage {
    ...
    func invokeAttachLowerProtocolForNewPath(
        ...
        _ = try mutableInstance.fromExternal { eventContext throws(NetworkError) in
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestDatagramMultipathLinkage: DatagramMultipathLinkage {
    ...
    public mutating func invokeAttachLowerProtocolForNewPath(
        ...
        switch protocolType {
        case .multiplexing(let instance):
            // The handler creates the path, binds both directions, and then announces it.
            var instance = instance
            _ = try instance.fromExternal { eventContext throws(NetworkError) in
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestInboundStreamLinkage: InboundStreamLinkage {
    ...
    public func handleInboundAbortedEvent(
        ...
        case .streamUpperHarness(let harness):
            harness.handleInboundAbortedEvent(error: error, for: instance, in: &eventContext)
        case .base: base.handleInboundAbortedEvent(error: error, for: instance, in: &eventContext)
        }
    }
    ...
    public func handleOutboundAbortedEvent(
        ...
        case .streamUpperHarness(let harness):
            harness.handleOutboundAbortedEvent(error: error, for: instance, in: &eventContext)
        case .base: base.handleOutboundAbortedEvent(error: error, for: instance, in: &eventContext)
        }
    }
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestOutboundStreamLinkage: OutboundStreamLinkage {
    ...
    public func sendStreamData(
        ...
        case .base: try base.sendStreamData(streamData, from: instance, in: &eventContext)
        }
    }
    ...
    public func sendEarlyStreamData(
        ...
        case .streamLowerHarness:
            ...
            streamData.finalizeAllFramesAsFailed()
            throw NetworkError.posix(ENOTSUP)
        case .base: try base.sendEarlyStreamData(streamData, from: instance, in: &eventContext)
        }
    }
    ...
    public func abortInbound(
        ...
        case .streamLowerHarness:
            ...
            throw NetworkError.posix(ENOTSUP)
        case .base: try base.abortInbound(error: error, for: instance, in: &eventContext)
        }
    }
    ...
    public func abortOutbound(
        ...
        case .streamLowerHarness:
            // Not supported by the harness, matching the framework's own linkage.
            throw NetworkError.posix(ENOTSUP)
        case .base: try base.abortOutbound(error: error, for: instance, in: &eventContext)
        }
    }
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestInboundStreamFlowLinkage: InboundStreamFlowLinkage {
...
@_spi(TestHarness)
@available(Network 0.1.0, *)
public struct TestStreamListenerLinkage: StreamListenerLinkage {
